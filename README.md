...
Web based SSH client with UI based on wetty/hterm. (see below)

App settings / connections are defined in `settings/app.json` json file.
...
*  `git clone https://github.com/sharq88/web-ssh`
